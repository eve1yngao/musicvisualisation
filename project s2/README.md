...
Represents loudnesses of different frequencies calculated using STFT as the amplitude of parts of a Sine Wave.

Press play on the python file t.py and select a WAV file to start.
#
**references**
